...
type AjaxActionSchema struct {
	...
	StaticSchema         accepts_credit_cards `json:"staticSchema"`
...
type ArrayControlSchema struct {
	...
	Validations                        data1                `json:"validations"`
	...
	InitAutoFill                       data1                `json:"initAutoFill"`
...
type ArrayElem35 struct {
	...
	DefaultValue accepts_credit_cards `json:"defaultValue"`
	Placeholder  string               `json:"placeholder"`
	Name         string               `json:"name"`
...
type CRUDCardsSchema struct {
	...
	FilterTogglable                data1                `json:"filterTogglable"`
...
type ComboCondition struct {
	...
	Items    []interface{}        `json:"items"`
	Label    string               `json:"label"`
	Scaffold accepts_credit_cards `json:"scaffold"`
	Mode     string               `json:"mode"`
}
...
type ConditionRule struct {
	Id    accepts_credit_cards `json:"id"`
...
type CustomField struct {
	...
	Placeholder  string               `json:"placeholder"`
	Name         string               `json:"name"`
	Value        accepts_credit_cards `json:"value"`
}
...
type Field_161becb8 struct {
	Prototype accepts_credit_cards `json:"prototype"`
	Length    float64              `json:"length"`
	Arguments accepts_credit_cards `json:"arguments"`
...
type FormHorizontal struct {
	Left       float64     `json:"left"`
	Right      float64     `json:"right"`
	LeftFixed  data1       `json:"leftFixed"`
...
type FormSchema struct {
	...
	Actions                     []interface{}        `json:"actions"`
	Body                        className            `json:"body"`
	Tabs                        accepts_credit_cards `json:"tabs"`
	FieldSet                    accepts_credit_cards `json:"fieldSet"`
	Data                        accepts_credit_cards `json:"data"`
...
type GridColumnObject struct {
	...
	WrapperCustomStyle accepts_credit_cards `json:"wrapperCustomStyle"`
	ThemeCss           accepts_credit_cards `json:"themeCss"`
}
...
type ListenerAction struct {
	...
	Expression      data1       `json:"expression"`
...
type PageSchema struct {
	...
	ToolbarClassName     className            `json:"toolbarClassName"`
	Definitions          accepts_credit_cards `json:"definitions"`
	Interval             float64              `json:"interval"`
	SilentPolling        bool                 `json:"silentPolling"`
...
type definitions struct {
	...
	ExpressionSimple                   data1                           `json:"ExpressionSimple"`
	...
	TrackConfig                        ArrayElem3                      `json:"trackConfig"`
	TestIdBuilder                      TestIdBuilder                   `json:"TestIdBuilder"`
	SchemaRemark                       data1                           `json:"SchemaRemark"`
	...
	SchemaTooltip                      data1                           `json:"SchemaTooltip"`
	SchemaApi                          data1                           `json:"SchemaApi"`
	...
	SchemaFunction                     data1                           `json:"SchemaFunction"`
	...
	DataTypePositionstringnumber       data1                           `json:"DataType.Position<(string|number)>"`
	...
	DataTypeBgSizestringnumber         data1                           `json:"DataType.BgSize<(string|number)>"`
	...
	DataTypeLineWidthstringnumber      data1                           `json:"DataType.LineWidth<(string|number)>"`
	...
	DataTypeTrackBreadthstringnumber   data1                           `json:"DataType.TrackBreadth<(string|number)>"`
	...
	DataTypeBgPositionstringnumber     data1                           `json:"DataType.BgPosition<(string|number)>"`
	...
	DataProvider                       data1                           `json:"DataProvider"`
	...
	ClassName                          data1                           `json:"ClassName"`
	LabelAlign                         string                          `json:"LabelAlign"`
...
type items struct {
	...
	Content   accepts_credit_cards `json:"content"`
	ClassName string               `json:"className"`
}
...
type patternProperties2 struct {
	PatternProperties accepts_credit_cards `json:"^(saveImmediately|resetOnFailed|reload|mode|icon)$"`
}

type patternProperties3 struct {
	PatternProperties accepts_credit_cards `json:"^(label|labelClassName|innerClassName|name|popOver|quickEdit|copyable)$"`
}

type patternProperties4 struct {
	PatternProperties accepts_credit_cards `json:"^(label|fixed|name|popOver|quickEdit|quickEditOnUpdate|copyable|sortable|searchable|toggled|width|align|vAlign|headerAlign|className|classNameExpr|labelClassName|filterable|breakpoint|remark|value|unique|canAccessSuperData|lazyRenderAfter|innerStyle)$"`
}

type patternProperties5 struct {
	PatternProperties accepts_credit_cards `json:"^(x|y|w|h|width|height|align|valign|gridClassName)$"`
}

type patternProperties6 struct {
	PatternProperties accepts_credit_cards `json:"^(rowClassName|cellClassName)$"`
}

type patternProperties7 struct {
	PatternProperties accepts_credit_cards `json:"^(unique|columnClassName|testid)$"`
}

type patternProperties8 struct {
	PatternProperties accepts_credit_cards `json:"^(columnClassName|columnRatio|name)$"`
}
...
type scaffold struct {
	Description string               `json:"description"`
	DefaultVal  accepts_credit_cards `json:"default"`
}
