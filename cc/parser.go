...
func (p *parser) statement(newBlock bool) *Statement {
	...
	case rune(DO), rune(FOR), rune(WHILE):
...
func (p *parser) typeSpecifier() *TypeSpecifier {
	...
	case rune(INT8):
		return &TypeSpecifier{Case: TypeSpecifierInt8, Token: p.shift(false)}
	case rune(INT16):
		return &TypeSpecifier{Case: TypeSpecifierInt16, Token: p.shift(false)}
	case rune(INT32):
		return &TypeSpecifier{Case: TypeSpecifierInt32, Token: p.shift(false)}
	case rune(INT64):
		return &TypeSpecifier{Case: TypeSpecifierInt64, Token: p.shift(false)}
	case rune(DECIMAL32):
