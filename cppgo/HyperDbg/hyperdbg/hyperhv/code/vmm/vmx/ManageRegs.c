...
VOID SetGuestIdtr(UINT64 Idtr) { VmxVmwrite64(VMCS_GUEST_IDTR_BASE, Idtr); }
...
VOID SetGuestLdtr(UINT64 Ldtr) { VmxVmwrite64(VMCS_GUEST_LDTR_BASE, Ldtr); }
...
VOID SetGuestGdtr(UINT64 Gdtr) { VmxVmwrite64(VMCS_GUEST_GDTR_BASE, Gdtr); }
...
VOID SetGuestTr(UINT64 Tr) { VmxVmwrite64(VMCS_GUEST_TR_BASE, Tr); }
...
VOID SetGuestRFlags(UINT64 RFlags) { VmxVmwrite64(VMCS_GUEST_RFLAGS, RFlags); }
...
VOID SetGuestRIP(UINT64 RIP) { VmxVmwrite64(VMCS_GUEST_RIP, RIP); }

VOID SetGuestRSP(UINT64 RSP) { VmxVmwrite64(VMCS_GUEST_RSP, RSP); }
...
VOID SetGuestCr0(UINT64 Cr0) { VmxVmwrite64(VMCS_GUEST_CR0, Cr0); }

VOID SetGuestCr2(UINT64 Cr2) { __writecr2(Cr2); }

VOID SetGuestCr3(UINT64 Cr3) { VmxVmwrite64(VMCS_GUEST_CR3, Cr3); }

VOID SetGuestCr4(UINT64 Cr4) { VmxVmwrite64(VMCS_GUEST_CR4, Cr4); }

VOID SetGuestCr8(UINT64 Cr8) { __writecr8(Cr8); }

VOID SetGuestDr0(UINT64 value) { __writedr(0, value); }

VOID SetGuestDr1(UINT64 value) { __writedr(1, value); }

VOID SetGuestDr2(UINT64 value) { __writedr(2, value); }

VOID SetGuestDr3(UINT64 value) { __writedr(3, value); }

VOID SetGuestDr6(UINT64 value) { __writedr(6, value); }

VOID SetGuestDr7(UINT64 value) { __writedr(7, value); }
