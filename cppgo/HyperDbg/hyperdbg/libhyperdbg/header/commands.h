...
typedef std::tuple<CommandParsingTokenType, std::string, std::string>
    CommandToken;

typedef VOID (*CommandFuncTypeParser)(vector<CommandToken> CommandTokens,
                                      string Command);
...
#define DEBUGGER_COMMAND_ATTRIBUTE_EVENT \
  0x2 | DEBUGGER_COMMAND_ATTRIBUTE_LOCAL_COMMAND_IN_DEBUGGER_MODE
