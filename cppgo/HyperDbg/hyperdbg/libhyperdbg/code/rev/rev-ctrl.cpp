...
BOOLEAN RevRequestService(
  ...
  Status = DeviceIoControl(
      g_DeviceHandle, IOCTL_REQUEST_REV_MACHINE_SERVICE, RevRequest,
      SIZEOF_REVERSING_MACHINE_RECONSTRUCT_MEMORY_REQUEST, RevRequest,
      SIZEOF_REVERSING_MACHINE_RECONSTRUCT_MEMORY_REQUEST, &ReturnedLength,
      NULL);
  if (!Status) {
