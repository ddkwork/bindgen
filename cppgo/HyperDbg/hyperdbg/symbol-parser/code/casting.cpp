...
BOOLEAN SymCastingQueryForFiledsAndTypes(
    const char *StructName, const char *FiledOfStructName,
    PBOOLEAN IsStructNamePointerOrNot, PBOOLEAN IsFiledOfStructNamePointerOrNot,
    char **NewStructOrTypeName, UINT32 *OffsetOfFieldFromTop,
    UINT32 *SizeOfField) {
...
int main() {
  ...
  if (SymCastingQueryForFiledsAndTypes(
          "STUPID_STRUCT2", "UnicodeStr", &IsStructPointerOrNot,
          &IsFieldPointerOrNot, &NewStructOrTypeName, &OffsetOfFieldFromTop,
          &SizeOfField)) {
