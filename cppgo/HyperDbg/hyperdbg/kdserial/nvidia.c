...
BOOLEAN NvidiaInitializePort(_In_opt_ _Null_terminated_ PCHAR LoadOptions,
...

{
  ...
  return Uart16550InitializePortCommon(LoadOptions, Port, MemoryMapped,
                                       AcpiGenericAccessSizeByte, 32);
}

UART_HARDWARE_DRIVER NvidiaHardwareDriver = {
    NvidiaInitializePort, Uart16550SetBaud, Uart16550GetByte, Uart16550PutByte,
    Uart16550RxReady};
