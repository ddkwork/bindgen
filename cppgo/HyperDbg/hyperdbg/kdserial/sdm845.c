...
#define HWIO_GENI_OUTPUT_CTRL_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_OUTPUT_CTRL_ADDR(x), m, v, \
                      HWIO_GENI_OUTPUT_CTRL_IN(x))
...
#define HWIO_GENI_CGC_CTRL_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_CGC_CTRL_ADDR(x), m, v, \
                      HWIO_GENI_CGC_CTRL_IN(x))
...
#define HWIO_GENI_SER_M_CLK_CFG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_SER_M_CLK_CFG_ADDR(x), m, v, \
                      HWIO_GENI_SER_M_CLK_CFG_IN(x))
...
#define HWIO_GENI_SER_S_CLK_CFG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_SER_S_CLK_CFG_ADDR(x), m, v, \
                      HWIO_GENI_SER_S_CLK_CFG_IN(x))
...
#define HWIO_GENI_DFS_IF_CFG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_DFS_IF_CFG_ADDR(x), m, v, \
                      HWIO_GENI_DFS_IF_CFG_IN(x))
...
#define HWIO_GENI_M_IRQ_ENABLE_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_M_IRQ_ENABLE_ADDR(x), m, v, \
                      HWIO_GENI_M_IRQ_ENABLE_IN(x))
...
#define HWIO_GENI_S_IRQ_ENABLE_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_S_IRQ_ENABLE_ADDR(x), m, v, \
                      HWIO_GENI_S_IRQ_ENABLE_IN(x))
...
#define HWIO_GENI_RX_FIFO_STATUS_IN(x)              \
  in_dword_masked(HWIO_GENI_RX_FIFO_STATUS_ADDR(x), \
...
#define HWIO_GENI_TX_WATERMARK_REG_IN(x)              \
  in_dword_masked(HWIO_GENI_TX_WATERMARK_REG_ADDR(x), \
...
#define HWIO_GENI_TX_WATERMARK_REG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_TX_WATERMARK_REG_ADDR(x), m, v, \
                      HWIO_GENI_TX_WATERMARK_REG_IN(x))
...
#define HWIO_GENI_RX_WATERMARK_REG_IN(x)              \
  in_dword_masked(HWIO_GENI_RX_WATERMARK_REG_ADDR(x), \
...
#define HWIO_GENI_RX_WATERMARK_REG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_RX_WATERMARK_REG_ADDR(x), m, v, \
                      HWIO_GENI_RX_WATERMARK_REG_IN(x))
...
#define HWIO_GENI_RX_RFR_WATERMARK_REG_IN(x)              \
  in_dword_masked(HWIO_GENI_RX_RFR_WATERMARK_REG_ADDR(x), \
...
#define HWIO_GENI_RX_RFR_WATERMARK_REG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_RX_RFR_WATERMARK_REG_ADDR(x), m, v, \
                      HWIO_GENI_RX_RFR_WATERMARK_REG_IN(x))
...
#define HWIO_UART_TX_TRANS_CFG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_UART_TX_TRANS_CFG_ADDR(x), m, v, \
                      HWIO_UART_TX_TRANS_CFG_IN(x))
...
#define HWIO_UART_TX_WORD_LEN_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_UART_TX_WORD_LEN_ADDR(x), m, v, \
                      HWIO_UART_TX_WORD_LEN_IN(x))
...
#define HWIO_UART_TX_STOP_BIT_LEN_IN(x)              \
  in_dword_masked(HWIO_UART_TX_STOP_BIT_LEN_ADDR(x), \
...
#define HWIO_UART_TX_STOP_BIT_LEN_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_UART_TX_STOP_BIT_LEN_ADDR(x), m, v, \
                      HWIO_UART_TX_STOP_BIT_LEN_IN(x))
...
#define HWIO_UART_TX_TRANS_LEN_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_UART_TX_TRANS_LEN_ADDR(x), m, v, \
                      HWIO_UART_TX_TRANS_LEN_IN(x))
...
#define HWIO_UART_RX_TRANS_CFG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_UART_RX_TRANS_CFG_ADDR(x), m, v, \
                      HWIO_UART_RX_TRANS_CFG_IN(x))
...
#define HWIO_UART_RX_WORD_LEN_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_UART_RX_WORD_LEN_ADDR(x), m, v, \
                      HWIO_UART_RX_WORD_LEN_IN(x))
...
#define HWIO_UART_RX_STALE_CNT_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_UART_RX_STALE_CNT_ADDR(x), m, v, \
                      HWIO_UART_RX_STALE_CNT_IN(x))
...
#define HWIO_UART_TX_PARITY_CFG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_UART_TX_PARITY_CFG_ADDR(x), m, v, \
                      HWIO_UART_TX_PARITY_CFG_IN(x))
...
#define HWIO_UART_RX_PARITY_CFG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_UART_RX_PARITY_CFG_ADDR(x), m, v, \
                      HWIO_UART_RX_PARITY_CFG_IN(x))
...
#define HWIO_GENI_DMA_MODE_EN_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_GENI_DMA_MODE_EN_ADDR(x), m, v, \
                      HWIO_GENI_DMA_MODE_EN_IN(x))
...
#define HWIO_DMA_GENERAL_CFG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_DMA_GENERAL_CFG_ADDR(x), m, v, \
                      HWIO_DMA_GENERAL_CFG_IN(x))
...
#define HWIO_SE_GSI_EVENT_EN_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_SE_GSI_EVENT_EN_ADDR(x), m, v, \
                      HWIO_SE_GSI_EVENT_EN_IN(x))
...
#define HWIO_QUPV3_SE_AHB_M_CFG_OUTM(x, m, v)                \
  out_dword_masked_ns(HWIO_QUPV3_SE_AHB_M_CFG_ADDR(x), m, v, \
                      HWIO_QUPV3_SE_AHB_M_CFG_IN(x))
...

{
  ...
  ConfigMask = (HWIO_DMA_GENERAL_CFG_AHB_SEC_SLV_CLK_CGC_ON_BMSK
  ...
  UART_DM_WRITE_REG(Port->Address + QUPV3_SE_DMA, HWIO_DMA_GENERAL_CFG_OFFS,
                    ConfigMask);
  UART_DM_WRITE_REG(Port->Address + GENI4_CFG, HWIO_GENI_CGC_CTRL_OFFS, 0x7F);
  UART_DM_WRITE_REG(Port->Address + GENI4_CFG, HWIO_GENI_FORCE_DEFAULT_REG_OFFS,
                    0x1);
  UART_DM_WRITE_REG(Port->Address + GENI4_CFG, HWIO_GENI_OUTPUT_CTRL_OFFS,
                    0x7F);
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_GENI_DMA_MODE_EN_OFFS, 0);
  UART_DM_WRITE_REG(Port->Address + QUPV3_SE_DMA, HWIO_SE_IRQ_EN_OFFS,
                    0xFFFFFFFF);
  UART_DM_WRITE_REG(Port->Address + QUPV3_SE_DMA, HWIO_SE_GSI_EVENT_EN_OFFS, 0);
  UART_DM_WRITE_REG(Port->Address + GENI4_DATA, HWIO_GENI_M_IRQ_ENABLE_OFFS,
                    0xB300005F);
  UART_DM_WRITE_REG(Port->Address + GENI4_DATA, HWIO_GENI_S_IRQ_ENABLE_OFFS,
                    0xB3007E5F);
  ConfigMask =
      UART_DM_READ_REG(Port->Address + QUPV3_SE_DMA, HWIO_SE_HW_PARAM_0_OFFS);
  ConfigMask = (ConfigMask & TX_FIFO_DEPTH_MASK) >> TX_FIFO_DEPTH_SHIFT;
  UART_DM_WRITE_REG(Port->Address + GENI4_DATA, HWIO_GENI_TX_WATERMARK_REG_OFFS,
                    4);
  ConfigMask =
      UART_DM_READ_REG(Port->Address + QUPV3_SE_DMA, HWIO_SE_HW_PARAM_1_OFFS);
  ConfigMask = (ConfigMask & RX_FIFO_DEPTH_MASK) >> RX_FIFO_DEPTH_SHIFT;
  UART_DM_WRITE_REG(Port->Address + GENI4_DATA, HWIO_GENI_RX_WATERMARK_REG_OFFS,
                    (ConfigMask - 8));
  UART_DM_WRITE_REG(Port->Address + GENI4_DATA,
                    HWIO_GENI_RX_RFR_WATERMARK_REG_OFFS, (ConfigMask - 4));
  SDM845SetBaud(Port, Port->BaudRate);
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_UART_TX_WORD_LEN_OFFS, 0x8);
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_UART_RX_WORD_LEN_OFFS, 0x8);
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_UART_TX_PARITY_CFG_OFFS, 0x0);
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_UART_TX_TRANS_CFG_OFFS, 0x2);
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_UART_RX_PARITY_CFG_OFFS, 0x0);
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_UART_RX_TRANS_CFG_OFFS, 0x0);
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_UART_TX_STOP_BIT_LEN_OFFS, 0x0);
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_UART_RX_STALE_CNT_OFFS, (0x16 * 10));
  UART_DM_WRITE_REG(Port->Address + GENI4_DATA, HWIO_GENI_S_CMD0_OFFS,
                    0x8000000);
  return TRUE;
}
...

{
  ...
  DivisorLatch =
      UART_DM_READ_REG(Port->Address + GENI4_CFG, HWIO_GENI_SER_M_CLK_CFG_OFFS);
  ...
  ValueTempMask =
      (DivisorLatch << (HWIO_GENI_SER_M_CLK_CFG_CLK_DIV_VALUE_SHFT)) |
      HWIO_GENI_SER_M_CLK_CFG_SER_CLK_EN_BMSK;
  UART_DM_WRITE_REG(Port->Address + GENI4_CFG, HWIO_GENI_SER_M_CLK_CFG_OFFS,
                    ValueTempMask);
  UART_DM_WRITE_REG(Port->Address + GENI4_CFG, HWIO_GENI_SER_S_CLK_CFG_OFFS,
                    ValueTempMask);
  Port->BaudRate = Rate;
  return TRUE;
}
...

{
  ...
  if (Transfer.AvailableBytes == 0) {
    ...
    IrqStatus =
        UART_DM_READ_REG(BaseAddress + GENI4_DATA, HWIO_GENI_S_IRQ_STATUS_OFFS);
    UART_DM_WRITE_REG(BaseAddress + GENI4_DATA, HWIO_GENI_S_IRQ_CLEAR_OFFS,
                      IrqStatus);
    RxFifoStatus = UART_DM_READ_REG(BaseAddress + GENI4_DATA,
                                    HWIO_GENI_RX_FIFO_STATUS_OFFS);
    PartialBytesToRead =
        (RxFifoStatus & RX_LAST_VALID_BYTES_MASK) >> RX_LAST_VALID_BYTES_SHIFT;
    ...
    if ((PartialBytesToRead > 0) || (WordsToRead > 0)) {
      ...
      WordsToRead = UART_DM_READ_REG(BaseAddress + GENI4_DATA,
    ...
    for (Index = 0; Index < WordsToRead; Index += 1) {
      RxFifo = UART_DM_READ_REG(BaseAddress + GENI4_DATA,
                                HWIO_GENI_RX_FIFOn_OFFS(BaseAddress, Index));
...

{
  ...
  if (BusyWait != FALSE) {
    while ((UART_DM_READ_REG(Port->Address + GENI4_CFG, HWIO_GENI_STATUS_OFFS) &
            HWIO_GENI_STATUS_M_GENI_CMD_ACTIVE_BMSK));
  } else if ((UART_DM_READ_REG(Port->Address + GENI4_CFG,
                               HWIO_GENI_STATUS_OFFS) &
              HWIO_GENI_STATUS_M_GENI_CMD_ACTIVE_BMSK)) {
    return UartNotReady;
  }
  UART_DM_WRITE_REG(Port->Address + GENI4_IMAGE_REGS,
                    HWIO_UART_TX_TRANS_LEN_OFFS, 1);
  UART_DM_WRITE_REG(Port->Address + GENI4_DATA, HWIO_GENI_M_CMD0_OFFS,
                    0x8000000);
  UINT32 word_value = 0;
  word_value = word_value | Byte;
  UART_DM_WRITE_REG(Port->Address + GENI4_DATA,
                    HWIO_GENI_TX_FIFOn_OFFS(Port->Address, 0), word_value);
  return UartSuccess;
}
...

{
  ...
  BaseAddress = Port->Address;
  FifoStatReg =
      UART_DM_READ_REG(BaseAddress + GENI4_DATA, HWIO_GENI_RX_FIFO_STATUS_OFFS);
  PartialBytesToRead =
      (FifoStatReg & RX_LAST_VALID_BYTES_MASK) >> RX_LAST_VALID_BYTES_SHIFT;
  ...
  if ((PartialBytesToRead > 0) || (WordsToRead > 0)) {
    ...
    if ((IrqStatus & RX_FIFO_WATERMARK_IRQ) != 0) {
      if (UART_DM_READ_REG(BaseAddress + GENI4_DATA,
                           HWIO_GENI_RX_WATERMARK_REG_OFFS) > 0) {
        IsAvailableBytes = TRUE;
      }
    }
  }
...
UART_HARDWARE_DRIVER SDM845HardwareDriver = {SDM845InitializePort,
                                             SDM845SetBaud, SDM845GetByte,
                                             SDM845PutByte, SDM845RxReady};
