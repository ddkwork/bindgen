...
IMPORT_EXPORT_VMM VOID VmFuncEventInjectPageFaultRangeAddress(
    UINT32 CoreId, UINT64 AddressFrom, UINT64 AddressTo, UINT32 PageFaultCode);
...
IMPORT_EXPORT_VMM VOID VmFuncIdtQueryEntries(
...
IMPORT_EXPORT_VMM INT32 VmFuncVmxCompatibleMemcmp(const CHAR *Address1,
                                                  const CHAR *Address2,
                                                  size_t Count);
IMPORT_EXPORT_VMM BOOLEAN VmFuncApicStoreLocalApicFields(
    PLAPIC_PAGE LocalApicBuffer, PBOOLEAN IsUsingX2APIC);
IMPORT_EXPORT_VMM BOOLEAN
...
IMPORT_EXPORT_VMM VOID ConfigureEnableMovToControlRegisterExitingOnSingleCore(
...
IMPORT_EXPORT_VMM VOID ConfigureSetEferSyscallOrSysretHookType(
...
IMPORT_EXPORT_VMM BOOLEAN ConfigureEptHook2(UINT32 CoreId, PVOID TargetAddress,
                                            PVOID HookFunction,
                                            UINT32 ProcessId);
IMPORT_EXPORT_VMM BOOLEAN ConfigureEptHook2FromVmxRoot(UINT32 CoreId,
                                                       PVOID TargetAddress,
                                                       PVOID HookFunction);
IMPORT_EXPORT_VMM BOOLEAN ConfigureEptHookMonitor(
    UINT32 CoreId, EPT_HOOKS_ADDRESS_DETAILS_FOR_MEMORY_MONITOR *HookingDetails,
    UINT32 ProcessId);
IMPORT_EXPORT_VMM BOOLEAN ConfigureEptHookMonitorFromVmxRoot(
    UINT32 CoreId,
    EPT_HOOKS_ADDRESS_DETAILS_FOR_MEMORY_MONITOR *MemoryAddressDetails);
IMPORT_EXPORT_VMM BOOLEAN ConfigureEptHookModifyInstructionFetchState(
    UINT32 CoreId, PVOID PhysicalAddress, BOOLEAN IsUnset);
IMPORT_EXPORT_VMM BOOLEAN ConfigureEptHookModifyPageReadState(
    UINT32 CoreId, PVOID PhysicalAddress, BOOLEAN IsUnset);
IMPORT_EXPORT_VMM BOOLEAN ConfigureEptHookModifyPageWriteState(
    UINT32 CoreId, PVOID PhysicalAddress, BOOLEAN IsUnset);
IMPORT_EXPORT_VMM BOOLEAN
...
IMPORT_EXPORT_VMM BOOLEAN ConfigureEptHookUnHookSingleAddress(
    UINT64 VirtualAddress, UINT64 PhysAddress, UINT32 ProcessId);
IMPORT_EXPORT_VMM BOOLEAN ConfigureEptHookUnHookSingleAddressFromVmxRoot(
...
IMPORT_EXPORT_VMM NTSTATUS
DirectVmcallPerformVmcall(UINT32 CoreId, UINT64 VmcallNumber,
                          DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallChangeMsrBitmapRead(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallChangeMsrBitmapWrite(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallChangeIoBitmap(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallEnableRdpmcExiting(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallEnableRdtscpExiting(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallEnableMov2DebugRegsExiting(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallSetExceptionBitmap(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallEnableExternalInterruptExiting(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallEnableMovToCrExiting(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallEnableEferSyscall(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallSetHiddenBreakpointHook(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallInvalidateEptAllContexts(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallInvalidateSingleContext(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallUnsetExceptionBitmap(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallUnhookSinglePage(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS
DirectVmcallSetDisableExternalInterruptExitingOnlyOnClearingInterruptEvents(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallResetMsrBitmapRead(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallResetMsrBitmapWrite(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS
DirectVmcallResetExceptionBitmapOnlyOnClearingExceptionEvents(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallResetIoBitmap(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallDisableRdtscExitingForClearingTscEvents(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallDisableRdpmcExiting(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallDisableEferSyscallEvents(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallDisableMov2DrExitingForClearingDrEvents(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM NTSTATUS DirectVmcallDisableMov2CrExitingForClearingCrEvents(
    UINT32 CoreId, DIRECT_VMCALL_PARAMETERS *DirectVmcallOptions);
IMPORT_EXPORT_VMM BOOLEAN DisassemblerShowInstructionsInVmxNonRootMode(
    PVOID Address, UINT32 Length, BOOLEAN Is32Bit);
IMPORT_EXPORT_VMM BOOLEAN DisassemblerShowOneInstructionInVmxNonRootMode(
    PVOID Address, UINT64 ActualRip, BOOLEAN Is32Bit);
...
IMPORT_EXPORT_VMM UINT64 VirtualAddressToPhysicalAddressByProcessId(
    _In_ PVOID VirtualAddress, _In_ UINT32 ProcessId);
IMPORT_EXPORT_VMM UINT64 VirtualAddressToPhysicalAddressByProcessCr3(
    _In_ PVOID VirtualAddress, _In_ CR3_TYPE TargetCr3);
IMPORT_EXPORT_VMM UINT64
...
IMPORT_EXPORT_VMM UINT64 PhysicalAddressToVirtualAddressByProcessId(
    _In_ PVOID PhysicalAddress, _In_ UINT32 ProcessId);
IMPORT_EXPORT_VMM UINT64 PhysicalAddressToVirtualAddressByCr3(
    _In_ PVOID PhysicalAddress, _In_ CR3_TYPE TargetCr3);
IMPORT_EXPORT_VMM UINT64
...
IMPORT_EXPORT_VMM PVOID MemoryMapperGetPteVaWithoutSwitchingByCr3(
    _In_ PVOID Va, _In_ PAGING_LEVEL Level, _In_ CR3_TYPE TargetCr3);
IMPORT_EXPORT_VMM PVOID
MemoryMapperGetPteVaOnTargetProcess(_In_ PVOID Va, _In_ PAGING_LEVEL Level);
IMPORT_EXPORT_VMM PVOID MemoryMapperSetExecuteDisableToPteOnTargetProcess(
    _In_ PVOID Va, _In_ BOOLEAN Set);
IMPORT_EXPORT_VMM BOOLEAN
MemoryMapperCheckPteIsPresentOnTargetProcess(PVOID Va, PAGING_LEVEL Level);
IMPORT_EXPORT_VMM BOOLEAN MemoryMapperReadMemorySafe(
    _In_ UINT64 VaAddressToRead, _Inout_ PVOID BufferToSaveMemory,
    _In_ SIZE_T SizeToRead);
IMPORT_EXPORT_VMM BOOLEAN MemoryMapperReadMemorySafeByPhysicalAddress(
    _In_ UINT64 PaAddressToRead, _Inout_ UINT64 BufferToSaveMemory,
    _In_ SIZE_T SizeToRead);
IMPORT_EXPORT_VMM BOOLEAN MemoryMapperReadMemorySafeOnTargetProcess(
    _In_ UINT64 VaAddressToRead, _Inout_ PVOID BufferToSaveMemory,
    _In_ SIZE_T SizeToRead);
IMPORT_EXPORT_VMM UINT32 DisassemblerLengthDisassembleEngine(PVOID Address,
                                                             BOOLEAN Is32Bit);
IMPORT_EXPORT_VMM UINT32
DisassemblerLengthDisassembleEngineInVmxRootOnTargetProcess(PVOID Address,
                                                            BOOLEAN Is32Bit);
IMPORT_EXPORT_VMM BOOLEAN MemoryMapperWriteMemorySafe(
    _Inout_ UINT64 Destination, _In_ PVOID Source, _In_ SIZE_T SizeToWrite,
    _In_ CR3_TYPE TargetProcessCr3);
IMPORT_EXPORT_VMM BOOLEAN MemoryMapperWriteMemorySafeOnTargetProcess(
    _Inout_ UINT64 Destination, _In_ PVOID Source, _In_ SIZE_T Size);
IMPORT_EXPORT_VMM BOOLEAN MemoryMapperWriteMemorySafeByPhysicalAddress(
    _Inout_ UINT64 DestinationPa, _In_ UINT64 Source, _In_ SIZE_T SizeToWrite);
IMPORT_EXPORT_VMM BOOLEAN MemoryMapperWriteMemoryUnsafe(
    _Inout_ UINT64 Destination, _In_ PVOID Source, _In_ SIZE_T SizeToWrite,
    _In_ UINT32 TargetProcessId);
IMPORT_EXPORT_VMM UINT64 MemoryMapperReserveUsermodeAddressOnTargetProcess(
    _In_ UINT32 ProcessId, _In_ BOOLEAN Allocate);
IMPORT_EXPORT_VMM BOOLEAN MemoryMapperFreeMemoryOnTargetProcess(
    _In_ UINT32 ProcessId, _Inout_ PVOID BaseAddress);
IMPORT_EXPORT_VMM BOOLEAN MemoryMapperSetSupervisorBitWithoutSwitchingByCr3(
    _In_ PVOID Va, _In_ BOOLEAN Set, _In_ PAGING_LEVEL Level,
    _In_ CR3_TYPE TargetCr3);
IMPORT_EXPORT_VMM BOOLEAN
...
IMPORT_EXPORT_VMM BOOLEAN MemoryManagerReadProcessMemoryNormal(
    HANDLE PID, PVOID Address, DEBUGGER_READ_MEMORY_TYPE MemType,
    PVOID UserBuffer, SIZE_T Size, PSIZE_T ReturnSize);
IMPORT_EXPORT_VMM BOOLEAN MemoryManagerWritePhysicalMemoryNormal(
    PVOID TargetAddress, PVOID UserBuffer, SIZE_T Size);
IMPORT_EXPORT_VMM BOOLEAN ReadPhysicalMemoryUsingMapIoSpace(
    PVOID PhysicalAddress, PVOID Buffer, SIZE_T BufferSize);
IMPORT_EXPORT_VMM BOOLEAN WritePhysicalMemoryUsingMapIoSpace(
    PVOID PhysicalAddress, PVOID Buffer, SIZE_T BufferSize);
IMPORT_EXPORT_VMM BOOLEAN PoolManagerCheckAndPerformAllocationAndDeallocation();
IMPORT_EXPORT_VMM BOOLEAN PoolManagerRequestAllocation(
    SIZE_T Size, UINT32 Count, POOL_ALLOCATION_INTENTION Intention);
IMPORT_EXPORT_VMM UINT64 PoolManagerRequestPool(
    POOL_ALLOCATION_INTENTION Intention, BOOLEAN RequestNewPool, UINT32 Size);
...
IMPORT_EXPORT_VMM BOOLEAN TransparentHideDebugger(
    PDEBUGGER_HIDE_AND_TRANSPARENT_DEBUGGER_MODE TransparentModeRequest);
IMPORT_EXPORT_VMM BOOLEAN TransparentUnhideDebugger(
    PDEBUGGER_HIDE_AND_TRANSPARENT_DEBUGGER_MODE TransparentModeRequest);
IMPORT_EXPORT_VMM VOID
...
IMPORT_EXPORT_VMM VOID BroadcastEnableMovControlRegisterExitingAllCores(
    PDEBUGGER_EVENT_OPTIONS BroadcastingOption);
IMPORT_EXPORT_VMM VOID BroadcastDisableMovToControlRegistersExitingAllCores(
    PDEBUGGER_EVENT_OPTIONS BroadcastingOption);
...
IMPORT_EXPORT_VMM QWORD PciReadCam(WORD Bus, WORD Device, WORD Function,
                                   BYTE Offset, UINT8 Width);
IMPORT_EXPORT_VMM BOOLEAN PciWriteCam(WORD Bus, WORD Device, WORD Function,
                                      BYTE Offset, UINT8 Width, QWORD Value);
