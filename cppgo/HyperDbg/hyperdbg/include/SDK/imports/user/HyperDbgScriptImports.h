...
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE BOOLEAN
HardwareScriptInterpreterCompressBuffer(UINT64 *Buffer, size_t BufferLength,
...
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE void PrintSymbolBuffer(
    const PVOID SymbolBuffer);
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE void RemoveSymbolBuffer(
    PVOID SymbolBuffer);
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE void PrintSymbol(PVOID Symbol);
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE UINT64 ScriptEngineConvertNameToAddress(
    const char *FunctionOrVariableName, PBOOLEAN WasFound);
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE UINT32 ScriptEngineLoadFileSymbol(
    UINT64 BaseAddress, const char *PdbFileName, const char *CustomModuleName);
...
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE BOOLEAN ScriptEngineGetFieldOffset(
    CHAR *TypeName, CHAR *FieldName, UINT32 *FieldOffset);
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE BOOLEAN
...
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE BOOLEAN ScriptEngineConvertFileToPdbPath(
    const char *LocalFilePath, char *ResultPath, size_t ResultPathSize);
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE BOOLEAN
ScriptEngineConvertFileToPdbFileAndGuidAndAgeDetails(const char *LocalFilePath,
                                                     char *PdbFilePath,
                                                     char *GuidAndAgeDetails,
                                                     BOOLEAN Is32BitModule);
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE BOOLEAN ScriptEngineSymbolInitLoad(
    PVOID BufferToStoreDetails, UINT32 StoredLength,
    BOOLEAN DownloadIfAvailable, const char *SymbolPath, BOOLEAN IsSilentLoad);
IMPORT_EXPORT_HYPERDBG_SCRIPT_ENGINE BOOLEAN
ScriptEngineShowDataBasedOnSymbolTypes(const char *TypeName, UINT64 Address,
