...
UINT64 GetPseudoRegValue(PSYMBOL Symbol, PACTION_BUFFER ActionBuffer) {
  switch (Symbol->Value) {
    ...
    case INVALID:
#ifdef SCRIPT_ENGINE_USER_MODE ShowMessages("error in reading regesiter");
#endif
      return INVALID;
    default:
#ifdef SCRIPT_ENGINE_USER_MODE ShowMessages("unknown pseudo-register");
#endif
      return INVALID;
  }
}
...
UINT64 GetValue(PGUEST_REGS GuestRegs, PACTION_BUFFER ActionBuffer,
  ...
  switch (Symbol->Type) {
    case SYMBOL_GLOBAL_ID_TYPE:
      if (ReturnReference)
        return ((UINT64)(&ScriptGeneralRegisters
                              ->GlobalVariablesList[Symbol->Value]));
      else
    ...
    case SYMBOL_TEMP_TYPE:
      if (ReturnReference)
        return (UINT64)&ScriptGeneralRegisters
            ->StackBuffer[ScriptGeneralRegisters->StackBaseIndx +
                          Symbol->Value];
      else
        return ScriptGeneralRegisters
            ->StackBuffer[ScriptGeneralRegisters->StackBaseIndx +
                          Symbol->Value];
    case SYMBOL_FUNCTION_PARAMETER_ID_TYPE:
      if (ReturnReference)
        return (UINT64)&ScriptGeneralRegisters
            ->StackBuffer[ScriptGeneralRegisters->StackBaseIndx - 3 -
                          Symbol->Value];
      else
        return ScriptGeneralRegisters
            ->StackBuffer[ScriptGeneralRegisters->StackBaseIndx - 3 -
  ...
  switch (Symbol->Type) {
    ...
    case SYMBOL_TEMP_TYPE:
      ScriptGeneralRegisters
          ->StackBuffer[ScriptGeneralRegisters->StackBaseIndx + Symbol->Value] =
          Value;
      return;
    case SYMBOL_FUNCTION_PARAMETER_ID_TYPE:
      ScriptGeneralRegisters
...
#ifdef SCRIPT_ENGINE_USER_MODE ShowMessages("err, expecting operator type\n");
    return HasError;
#endif
  };
  switch (Operator->Value) {
    case FUNC_ED:
      Src0 = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                       (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      SrcVal0 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters, Src0,
                         FALSE);
      Src1 = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                       (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      SrcVal1 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters, Src1,
                         FALSE);
    ...
    case FUNC_INTERLOCKED_EXCHANGE:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionInterlockedExchange(
          (volatile long long *)SrcVal1, SrcVal0, &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_INTERLOCKED_EXCHANGE_ADD:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionInterlockedExchangeAdd(
          (volatile long long *)SrcVal1, SrcVal0, &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_INTERLOCKED_COMPARE_EXCHANGE:
      ...
      *Indx = *Indx + 1;
      ...
      Src2 = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                       (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      SrcVal2 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters, Src2,
                         FALSE);
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionInterlockedCompareExchange(
          (volatile long long *)SrcVal2, SrcVal1, SrcVal0, &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_EVENT_INJECT_ERROR_CODE:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      ScriptEngineFunctionEventInjectErrorCode((UINT32)SrcVal2, (UINT32)SrcVal1,
                                               (UINT32)SrcVal0, &HasError);
      break;
    case FUNC_MEMCPY:
      Src0 = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                       (unsigned long long)(*Indx * sizeof(SYMBOL)));
    ...
    case FUNC_MEMCPY_PA:
      ...
      *Indx = *Indx + 1;
      SrcVal2 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters, Src2,
                         FALSE);
      ScriptEngineFunctionMemcpyPa(SrcVal2, SrcVal1, (UINT32)SrcVal0,
                                   &HasError);
      break;
    case FUNC_SPINLOCK_LOCK_CUSTOM_WAIT:
      ...
      *Indx = *Indx + 1;
      SrcVal1 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters, Src1,
                         FALSE);
      ScriptEngineFunctionSpinlockLockCustomWait((volatile long *)SrcVal1,
                                                 (UINT32)SrcVal0, &HasError);
      break;
    case FUNC_EVENT_INJECT:
      ...
      *Indx = *Indx + 1;
      SrcVal1 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters, Src1,
                         FALSE);
      ScriptEngineFunctionEventInject((UINT32)SrcVal1, (UINT32)SrcVal0,
                                      &HasError);
      break;
    case FUNC_PAUSE:
      ScriptEngineFunctionPause(ActionDetail, GuestRegs);
      break;
    case FUNC_FLUSH:
    ...
    case FUNC_POI:
      ...
      *Indx = *Indx + 1;
      DesVal = ScriptEngineKeywordPoi(
          (PUINT64)GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters,
                            Src0, FALSE),
          &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    ...
    case FUNC_POI_PA:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineKeywordPoiPa(
          (PUINT64)GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters,
                            Src0, FALSE),
          &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
    ...
    case FUNC_DB_PA:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineKeywordDbPa(
          (PUINT64)GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters,
                            Src0, FALSE),
          &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
    ...
    case FUNC_DD_PA:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineKeywordDdPa(
          (PUINT64)GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters,
                            Src0, FALSE),
          &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
    ...
    case FUNC_DW_PA:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineKeywordDwPa(
          (PUINT64)GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters,
                            Src0, FALSE),
          &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
    ...
    case FUNC_DQ_PA:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineKeywordDqPa(
          (PUINT64)GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters,
                            Src0, FALSE),
          &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
    ...
    case FUNC_REFERENCE:
      ...
      *Indx = *Indx + 1;
      SrcVal0 =
          GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters, Src0, TRUE);
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = SrcVal0;
    ...
    case FUNC_PHYSICAL_TO_VIRTUAL:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionPhysicalToVirtual(GetValue(
          GuestRegs, ActionDetail, ScriptGeneralRegisters, Src0, FALSE));
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_VIRTUAL_TO_PHYSICAL:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionVirtualToPhysical(GetValue(
          GuestRegs, ActionDetail, ScriptGeneralRegisters, Src0, FALSE));
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    ...
    case FUNC_STRLEN:
      ...
      *Indx = *Indx + 1;
      if (Src0->Type == SYMBOL_STRING_TYPE) {
        *Indx =
            *Indx + ((SIZE_SYMBOL_WITHOUT_LEN + Src0->Len) / sizeof(SYMBOL));
        SrcVal0 = (UINT64)&Src0->Value;
      } else {
        SrcVal0 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters,
                           Src0, FALSE);
      }
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
    ...
    case FUNC_INTERLOCKED_INCREMENT:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionInterlockedIncrement(
          (volatile long long *)SrcVal0, &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_INTERLOCKED_DECREMENT:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionInterlockedDecrement(
          (volatile long long *)SrcVal0, &HasError);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_NEG:
    ...
    case FUNC_PUSH:
      ...
      *Indx = *Indx + 1;
      SrcVal0 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters, Src0,
                         FALSE);
      ScriptGeneralRegisters->StackBuffer[ScriptGeneralRegisters->StackIndx] =
          SrcVal0;
      ScriptGeneralRegisters->StackIndx++;
      break;
    case FUNC_POP:
      ScriptGeneralRegisters->StackIndx--;
      SrcVal0 = ScriptGeneralRegisters
                    ->StackBuffer[ScriptGeneralRegisters->StackIndx];
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
    ...
    case FUNC_STRCMP:
      ...
      *Indx = *Indx + 1;
      if (Src1->Type == SYMBOL_STRING_TYPE) {
        *Indx =
            *Indx + ((SIZE_SYMBOL_WITHOUT_LEN + Src1->Len) / sizeof(SYMBOL));
        SrcVal1 = (UINT64)&Src1->Value;
      } else {
        SrcVal1 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters,
                           Src1, FALSE);
      }
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionStrcmp((const char *)SrcVal1,
                                          (const char *)SrcVal0);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_WCSCMP:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionWcscmp((const wchar_t *)SrcVal1,
                                          (const wchar_t *)SrcVal0);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_MEMCMP:
      Src0 = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
      ...
      *Indx = *Indx + 1;
      if (Src2->Type == SYMBOL_STRING_TYPE) {
        *Indx =
            *Indx + ((SIZE_SYMBOL_WITHOUT_LEN + Src2->Len) / sizeof(SYMBOL));
        SrcVal2 = (UINT64)&Src2->Value;
      } else {
        SrcVal2 = GetValue(GuestRegs, ActionDetail, ScriptGeneralRegisters,
                           Src2, FALSE);
      }
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionMemcmp((const char *)SrcVal2,
                                          (const char *)SrcVal1, SrcVal0);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_STRNCMP:
      Src0 = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionStrncmp((const char *)SrcVal2,
                                           (const char *)SrcVal1, SrcVal0);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_WCSNCMP:
      ...
      *Indx = *Indx + 1;
      ...
      Des = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                      (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      DesVal = ScriptEngineFunctionWcsncmp((const wchar_t *)SrcVal2,
                                           (const wchar_t *)SrcVal1, SrcVal0);
      SetValue(GuestRegs, ScriptGeneralRegisters, Des, DesVal);
      break;
    case FUNC_PRINTF:
      Src0 = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                       (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      *Indx = *Indx + ((SIZE_SYMBOL_WITHOUT_LEN + Src0->Len) / sizeof(SYMBOL));
      Src1 = (PSYMBOL)((unsigned long long)CodeBuffer->Head +
                       (unsigned long long)(*Indx * sizeof(SYMBOL)));
      *Indx = *Indx + 1;
      Src2 = NULL;
      ...
      ScriptEngineFunctionPrintf(
          GuestRegs, ActionDetail, ScriptGeneralRegisters, ActionDetail->Tag,
