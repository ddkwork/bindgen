...
[![Go Reference](https://pkg.go.dev/badge/github.com/ddkwork/miqt/qt.svg)](https://pkg.go.dev/github.com/ddkwork/miqt/qt)
[![GitHub Actions CI](https://github.com/ddkwork/miqt/actions/workflows/miqt.yml/badge.svg?branch=master)](https://github.com/ddkwork/miqt/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/ddkwork/miqt)](https://goreportcard.com/report/github.com/ddkwork/miqt)
...
- [code_edit](https://github.com/ddkwork/miqt/discussions/259), a QSyntaxHighlighter for Go source code
...
- [mdoutliner](https://github.com/ddkwork/miqt/tree/master/examples/mdoutliner), Markdown Outliner sample application
...
- See more users of the [qt5](https://pkg.go.dev/github.com/ddkwork/miqt/qt?tab=importedby) or [qt6](https://pkg.go.dev/github.com/ddkwork/miqt/qt6?tab=importedby) packages
...
The first time MIQT is used, your `go build` would take [about 10 minutes](https://github.com/ddkwork/miqt/discussions/65). But after that, any `go build` is very fast.

Go 1.26 is significantly faster.

If you are compiling your app within a Dockerfile, you could cache the build step by running `go install github.com/ddkwork/miqt/qt`.
...
See also [issue #8](https://github.com/ddkwork/miqt/issues/8).
...
```bash
go install github.com/ddkwork/miqt/cmd/miqt-uic@latest
go install github.com/ddkwork/miqt/cmd/miqt-rcc@latest
```
...
The import path changes from `github.com/ddkwork/miqt/qt` to `github.com/ddkwork/miqt/qt6`, but most basic classes are the same.

You can update all imports by running `find . -type f -name .go -exec sed -i 's_"github.com/ddkwork/miqt/qt"_qt "github.com/ddkwork/miqt/qt6"_' {} \;`
...
```bash
go install github.com/ddkwork/miqt/cmd/miqt-docker@latest
...
> If you get an error related to `pkg-config` when building the miqt application after installing the `pkg-config` tool with **brew**, you may have forgotten to add environment variables. To do this, do not forget to apply the instructions in the output of `brew install pkg-config` command. You can find related discussion about this topic by clicking this link -> https://github.com/ddkwork/miqt/discussions/257.
...
```bash
go install github.com/ddkwork/miqt/cmd/miqt-docker
